    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/60 backdrop-blur-[2px]">
            <div className="bg-white border-[4px] border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] w-full max-w-lg overflow-hidden flex flex-col">
                ...
                {/* Header */}
                <header className="p-6 border-b-[4px] border-black flex justify-between items-center bg-[#FFD600]">
                    ...
                    <button
                        onClick={onClose}
                        className="w-10 h-10 border-[3px] border-black bg-white hover:bg-[#FF6B6B] flex items-center justify-center text-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none transition-all"
                    >
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <button
                                ...
                                className={`p-4 border-[3px] border-black text-left flex items-center gap-3 transition-all ${provider === 'openrouter'
                                        ? 'bg-[#00D1FF] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]'
                                        : 'bg-white hover:bg-slate-50'
                                    }`}
                            >
                    ...
                    {provider === 'google' ? (
                        <div className="space-y-3">
                            ...
                            <input
                                ...
                                placeholder="AIza..."
                                className="w-full p-4 text-sm font-bold bg-white border-[3px] border-black outline-none focus:bg-[#FFF4B8] transition-colors placeholder:text-black/30 neo-brutalism-input"
                            />
